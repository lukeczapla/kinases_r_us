...
integrator = LangevinAMDForceGroupIntegrator(100.0*kilojoules_per_mole, 150*kilojoules_per_mole,group=2, temperature=inputs.temp*kelvin, timestep=inputs.dt*picoseconds, collision_rate=inputs.fric_coeff / picoseconds)
...
if inputs.nstep > 0:
    ...
    if inputs.annealing == 'yes':
        ...
        for j in range(int(inputs.nstep/5000)):
            ...
            for i in range(500):
                simulation.step(10)
                #dV.append(integrator.getGlobalVariable(7))
