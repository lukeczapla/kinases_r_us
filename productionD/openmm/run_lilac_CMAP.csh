...
set prod_step   = /data/aiml/czaplal/snapshots/prodDCMAP
...
while ( ${cnt} <= ${cntmax} )
    ...
    python -u openmm_run_CMAP.py -i ${prod_prefix}.inp ${input_param} -orst ${istep}.rst -odcd ${istep}.dcd --platform ${platform} > ${istep}.out
    @ cnt += 1
end
